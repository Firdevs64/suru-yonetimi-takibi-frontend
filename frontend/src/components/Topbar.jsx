      ...
      <div className="flex items-center gap-4">
        ...
        <Link to="/profile" className="flex items-center gap-3 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-100 hover:bg-gray-100 transition-colors cursor-pointer">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-black text-gray-900 tracking-tight">{user?.fullName || user?.name || 'Misafir'}</p>
            <p className="text-[10px] font-black text-primary-600 bg-primary-50 px-2 py-0.5 rounded-lg uppercase tracking-widest">{user?.role || 'Çiftçi'}</p>
          </div>
